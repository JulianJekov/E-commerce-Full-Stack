        ...
        <>
                                        ...
                                        <tr className='p-4 bg-white border-b'>
                                            <td>
                                                <div className='flex p-4'>
                                                    <img src={item?.thumbnail} alt={'product-' + index}
            ...
            >
                ...
                <div className='flex justify-between p-4'>
                    ...
                    <button className='bg-black text-white w-[80px] h-[48px] border rounded-lg'
                            onClick={onDeleteItem}>Remove
                    </button>
                </div>
            </Modal>
        </>
